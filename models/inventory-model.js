...
/* ***************************
 *  Get details of inventory item by inv_id
 * ************************** */
 ...
 * ********************* */
  ...
  async function checkExistingInventory(inv_model){
    try {
      ...
      const classification = await pool.query(sql, [inv_model])
      return classification.rowCount
    } catch (error) {
      return error.message
    }
...
module.exports = {getClassifications, getInventoryByClassificationId, getItemByInventoryId, addClassification, checkExistingClassification, addInventory, checkExistingInventory, updateInventory, deleteInventory}
